"""POST /api/plugins/parley/slack_messages — fetch recent messages from a Slack channel."""
...
class SlackMessagesApi(ApiHandler):
                ...
                "messages": [
                    {
                        ...
                        "author": user_map.get(m.author_id, m.author_id or "?"),
                        "content": m.content,
